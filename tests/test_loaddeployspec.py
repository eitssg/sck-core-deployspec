...
def test_load_deployspec_yaml_format(test_data_dir):
...
def test_load_deployspec_json_format(test_data_dir):
...
def test_load_deployspec_struct_format(test_data_dir):
...
def test_load_deployspec_json_error_handling(test_data_dir):
...
def test_load_deployspec_no_file_found():
...
def test_load_deployspec_current_directory_no_file(test_data_dir):
...
def test_load_deployspec_invalid_directory():
...
def test_load_deployspec_default_current_directory(test_data_dir):
...
def test_load_deployspec_various_formats(test_data_dir, folder_name, expected_actions):
